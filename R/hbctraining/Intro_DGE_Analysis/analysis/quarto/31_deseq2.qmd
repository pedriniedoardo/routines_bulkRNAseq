...
![deseq1](img/deseq2_workflow_separate.png){width="500"}
:::
...
::: {fig-align="center"}
![deseq1](img/deseq2_workflow_separate_sf.png){width="200"}
:::
...
```{r}
cbind(
  data.frame(sizeFactor = sizeFactors(dds)),
  data.frame(totCounts = colSums(counts(dds)))
  ) %>%
  ggplot(aes(x=sizeFactor,totCounts)) + geom_point() + theme_bw()
```
...
```{r}
cbind(
  data.frame(totCounts_norm = colSums(counts(dds, normalized=T))),
  data.frame(totCounts_raw = colSums(counts(dds)))
  ) %>%
  ggplot(aes(x=totCounts_norm,totCounts_raw)) + geom_point() + theme_bw()
```
...
![deseq2](img/deseq2_workflow_separate_dis.png){width="200"}
:::
...
::: {#fig-deseq3 fig-align="center"}
![deseq3](img/deseq_mean_variance2.png){width="600"}
:::
...
::: {#fig-deseq4 fig-align="center"}
![deseq4](img/deseq_dispersion1.png){width="400"}
:::
...
::: {#fig-deseq5 fig-align="center"}
![deseq5](img/deseq2_workflow_separate_fit.png){width="200"}
:::
...
::: {#fig-deseq6 fig-align="center"}
![deseq5](img/deseq_dispersion1.png){width="400"}
:::
...
::: {#fig-shr1 fig-align="center"}
![shr1](img/deseq2_workflow_separate_shr.png){width="200"}
:::
...
::: {#fig-disp fig-align="center"}
![disp](img/deseq_dispersion2){width="600"}
:::
...
The plot below shows a cloud of dispersion values, which do not generally follow the curve. This would be worrisome and suggests a bad fit of the data to the model. ::: {#fig-disp2 fig-align="center"} ![disp2](img/bad_dispersion1.png){width="600"} :::
...
::: {#fig-disp3 fig-align="center"}
![disp3](img/bad_dispersion2.png){width="500"}
:::
...
::: {fig-align="center"}
![disp](img/exercise_dispersion.png){width="500"}
:::
