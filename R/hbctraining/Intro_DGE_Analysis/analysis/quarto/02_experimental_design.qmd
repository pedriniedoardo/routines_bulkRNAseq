...
![replicate](img/replicates.png){width="500"}
...
![replicate2](img/de_replicates_img2.png){width="500"}
...
![batch](img/batch_effect_pca.png){width="600"}
...
![batch2](img/confounded_batch.png){width="300"}
*Image credit: [Hicks SC, et al., bioRxiv (2015)](https://www.biorxiv.org/content/early/2015/08/25/025528)*
:::
...
![batch3](img/batch_effect.png){width="300"}
*Image credit: [Hicks SC, et al., bioRxiv (2015)](https://www.biorxiv.org/content/early/2015/08/25/025528)*
:::
